...
public class GuestbookAssetRendererFactory extends BaseAssetRendererFactory<Guestbook> {
    ...
    private static final String TYPE = "guestbook";
    ...
    public boolean hasPermission(PermissionChecker permissionChecker,
        ...
        Guestbook guestbook = _guestbookLocalService.getGuestbook(classPK);
        return GuestbookPermission.contains(permissionChecker, guestbook.getGroupId(), actionId);
    }
    ...
    @Reference(unbind = "-")
    public void set_guestbookLocalService(GuestbookLocalService _guestbookLocalService) {
        this._guestbookLocalService = _guestbookLocalService;
    }
}
